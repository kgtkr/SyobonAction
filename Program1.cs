    ...
    static partial class Program
    {
            ...
            if (main == 1 && zxon >= 1)
            {
                ...
                for (t = 0; t < amax; t++)
                {
                    ...
                    if (atype[t] == 87 || atype[t] == 88)
                    {
                        if (xx[0] + xx[2] * 100 >= -10 - xx[14] && xx[1] <= fxmax + xx[14] && xx[1] + xx[3] * 100 >= -10 && xx[3] <= fymax)
                        {
                            ...
                            {
                                xx[26] = 18;
                                xd[4] = tt * xx[26] * Math.Cos(atm[t] * pai / 180 / 2);
                                xd[5] = tt * xx[26] * Math.Sin(atm[t] * pai / 180 / 2);
                                xx[24] = (int)xd[4];
                                xx[25] = (int)xd[5];
                                setcolor(230, 120, 0);
                                xx[23] = 8;
                ...
                for (t = 0; t < amax; t++)
                {
                    if (amsgtm[t] >= 1)
                    {
                        ...
                        if (amsgtype[t] == 16) xs[0] = "丸腰で勝てるとでも?";
                        if (amsgtype[t] == 17) xs[0] = "パリイ!!";
        ...
        static void Mainprogram()
        {
                        ...
                        switch (atype[t])
                        {
                            ...
                            case 4:
                                ...
                                if (Math.Abs(ma + mnobia - xx[8] - xx[0] * 2) < 9000 &&
                                    Math.Abs((ma < xx[8] - anobia[t] + xx[0] * 2) ? 1 : 0) < 3000 &&
                                    md <= -600 && atm[t] <= 0)
                                {
                            ...
                            case 87:
                                ...
                                {
                                    xx[26] = 18;
                                    xd[4] = tt * xx[26] * Math.Cos(atm[t] * pai / 180 / 2); xd[5] = tt * xx[26] * Math.Sin(atm[t] * pai / 180 / 2);
            ...
            if (main == 2)
            {
                ...
                if (DX.CheckHitKey(DX.KEY_INPUT_SPACE) == 1) { for (t = 0; t <= xx[7]; t += 1) { xx[12 + t] -= 300; } }
