                    ...
                    if (nプレイヤー.type != 200 && nプレイヤー.type != 1 && nプレイヤー.type != 2)
                    {
                        ...
                        {//xx_9+xx_1+3000<mb && // && mb>xx_9-xx_0*2
                            if (xx_17 == 1)
                            {
                                ...
                                if (nブロック[t_].xtype == 0) v敵キャラアイテム作成(nブロック[t_].a, nブロック[t_].b, 0, 0, 0, 0, 0);
                                if (nブロック[t_].xtype == 1) v敵キャラアイテム作成(nブロック[t_].a, nブロック[t_].b, 0, 0, 0, 4, 0);
                                if (nブロック[t_].xtype == 3) v敵キャラアイテム作成(nブロック[t_].a, nブロック[t_].b, 0, 0, 0, 101, 0);
                                if (nブロック[t_].xtype == 4) { n敵キャラ[n敵キャラco].brocktm = 20; v敵キャラアイテム作成(nブロック[t_].a - 400, nブロック[t_].b - 1600, 0, 0, 0, 6, 0); }
                                if (nブロック[t_].xtype == 10) v敵キャラアイテム作成(nブロック[t_].a, nブロック[t_].b, 0, 0, 0, 101, 0);
                            }
                        }//101
                        ...
                        if (nブロック[t_].type == 102)
                        {
                            if (xx_17 == 1)
                            {
                                ...
                                if (nブロック[t_].xtype == 0) v敵キャラアイテム作成(nブロック[t_].a, nブロック[t_].b, 0, 0, 0, 100, 0);
                                if (nブロック[t_].xtype == 2) v敵キャラアイテム作成(nブロック[t_].a, nブロック[t_].b, 0, 0, 0, 100, 2);
                                if (nブロック[t_].xtype == 3) v敵キャラアイテム作成(nブロック[t_].a, nブロック[t_].b, 0, 0, 0, 102, 1);
                            }
                        }//102
                        ...
                        if (nブロック[t_].type == 103)
                        {
                            ...
                            {
                                v効果音再生(Res.nオーディオ8);
                                nブロック[t_].type = 3; n敵キャラ[n敵キャラco].brocktm = 16; v敵キャラアイテム作成(nブロック[t_].a, nブロック[t_].b, 0, 0, 0, 100, 1);
                            }
                        }//103
                        ...
                        if (nブロック[t_].type == 104)
                        {
                            ...
                            {
                                v効果音再生(Res.nオーディオ8);
                                nブロック[t_].type = 3; n敵キャラ[n敵キャラco].brocktm = 16; v敵キャラアイテム作成(nブロック[t_].a, nブロック[t_].b, 0, 0, 0, 110, 0);
                            }
                        }//104
                        ...
                        if (nブロック[t_].type == 111 && nブロック[t_].a - fx >= 0)
                        {
                            nブロック[t_].hp++; if (nブロック[t_].hp >= 16)
                            {
                                nブロック[t_].hp = 0;
                                v効果音再生(Res.nオーディオ8);
                                n敵キャラ[n敵キャラco].brocktm = 16; v敵キャラアイテム作成(nブロック[t_].a, nブロック[t_].b, 0, 0, 0, 102, 1);
                            }
                        }
