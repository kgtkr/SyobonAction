                    ...
                    if ((n地面[t_].type <= 99 || n地面[t_].type == 200) && nプレイヤー.type < 10)
                    {
                        ...
                        if (ma + nプレイヤー.nobia > xx_8 + xx_0 && ma < xx_8 + n地面[t_].c - xx_0 && nプレイヤー.b + nプレイヤー.nobib > xx_9 && nプレイヤー.b < xx_9 + n地面[t_].d + xx_0)
                        {
                            if (n地面[t_].type == 100)
                            {
                                ...
                                {
                                    var ec = new C敵キャラ();
                                    v敵キャラアイテム作成(ec,n地面[t_].a + 1000, 32000, 0, 0, 0, 3, 0); n地面[t_].a = -800000000; v効果音再生(Res.nオーディオ10);
                                    n敵キャラ.Add(ec);
                                }
                            }
                            if (n地面[t_].type == 101) {
                                var ec = new C敵キャラ();
                                v敵キャラアイテム作成(ec,n地面[t_].a + 6000, -4000, 0, 0, 0, 3, 1); n地面[t_].a = -800000000; v効果音再生(Res.nオーディオ10);
                                n敵キャラ.Add(ec);
                            }
                            if (n地面[t_].type == 102)
                            {
                                if (n地面[t_].xtype == 0)
                                {
                                    for (int t3 = 0; t3 <= 3; t3++) {
                                        var ec = new C敵キャラ();
                                        v敵キャラアイテム作成(ec,n地面[t_].a + t3 * 3000, -3000, 0, 0, 0, 0, 0);
                                        n敵キャラ.Add(ec);
                                    }
                                }
                                if (n地面[t_].xtype == 1 && nプレイヤー.b >= 16000) {
                                    var ec = new C敵キャラ();
                                    v敵キャラアイテム作成(ec,n地面[t_].a + 1500, 44000, 0, -2000, 0, 4, 0);
                                    n敵キャラ.Add(ec);
                                }
                                else if (n地面[t_].xtype == 2) {
                                    var ec = new C敵キャラ();
                                    v敵キャラアイテム作成(ec,n地面[t_].a + 4500, 30000, 0, -1600, 0, 5, 0);
                                    n敵キャラ.Add(ec);
                                    v効果音再生(Res.nオーディオ10);
                                    n地面[t_].xtype = 3; n地面[t_].a -= 12000;
                                }
                                else if (n地面[t_].xtype == 3) {
                                    n地面[t_].a += 12000;
                                    n地面[t_].xtype = 4;
                                }
                                else if (n地面[t_].xtype == 4) {
                                    var ec = new C敵キャラ();
                                    v敵キャラアイテム作成(ec,n地面[t_].a + 4500, 30000, 0, -1600, 0, 5, 0);
                                    n敵キャラ.Add(ec);
                                    v効果音再生(Res.nオーディオ10);
                                ...
                                else if (n地面[t_].xtype == 8) {
                                    var ec = new C敵キャラ();
                                    v敵キャラアイテム作成(ec,n地面[t_].a - 5000 - 3000 * 1, 26000, 0, -1600, 0, 5, 0);
                                    n敵キャラ.Add(ec);
                                    v効果音再生(Res.nオーディオ10);
                                }
                                else if (n地面[t_].xtype == 9) {
                                    for (int t3 = 0; t3 <= 2; t3++) {
                                        var ec = new C敵キャラ();
                                        v敵キャラアイテム作成(ec,n地面[t_].a + t3 * 3000 + 3000, 48000, 0, -6000, 0, 3, 0);
                                        n敵キャラ.Add(ec);
                                    }
                                }
                                ...
                                if (n地面[t_].xtype == 12)
                                {
                                    for (int t3 = 1; t3 <= 3; t3++) {
                                        var ec = new C敵キャラ();
                                        v敵キャラアイテム作成(ec,n地面[t_].a + t3 * 3000 - 1000, 40000, 0, -2600, 0, 9, 0);
                                        n敵キャラ.Add(ec);
                                    }
                                }
                            ...
                            if (n地面[t_].type == 103)
                            {
                                if (n地面[t_].xtype == 0)
                                {
                                    ...
                                    ec.msgtm = 10;
                                    ec.msgtype = 50;
                                    v敵キャラアイテム作成(ec,n地面[t_].a + 9000, n地面[t_].b + 2000, 0, 0, 0, 79, 0);
                                    n敵キャラ.Add(ec);
                                    n地面[t_].a = -800000000;
                                }
                                ...
                                if (n地面[t_].xtype == 1 && nブロック[6].type <= 6)
                                {
                                    ...
                                    ec.msgtm = 10;
                                    ec.msgtype = 50;
                                    v敵キャラアイテム作成(ec,n地面[t_].a - 12000, n地面[t_].b + 2000, 0, 0, 0, 79, 0);
                                    n敵キャラ.Add(ec);
                                    n地面[t_].a = -800000000;
                            ...
                            if (n地面[t_].type == 104)
                            {
                                if (n地面[t_].xtype == 0)
                                {
                                    ...
                                    ec = new C敵キャラ();
                                    v敵キャラアイテム作成(ec,n地面[t_].a + 12000, n地面[t_].b + 2000 + 3000, 0, 0, 0, 79, 0);
                                    n敵キャラ.Add(ec);

                                    ec = new C敵キャラ();
                                    v敵キャラアイテム作成(ec, n地面[t_].a + 12000, n地面[t_].b + 2000 + 3000, 0, 0, 0, 79, 1);
                                    n敵キャラ.Add(ec);

                                    ec = new C敵キャラ();
                                    v敵キャラアイテム作成(ec, n地面[t_].a + 12000, n地面[t_].b + 2000 + 3000, 0, 0, 0, 79, 2);
                                    n敵キャラ.Add(ec);

                                    ec = new C敵キャラ();
                                    v敵キャラアイテム作成(ec, n地面[t_].a + 12000, n地面[t_].b + 2000 + 3000, 0, 0, 0, 79, 3);
                                    n敵キャラ.Add(ec);

                                    ec = new C敵キャラ();
                                    v敵キャラアイテム作成(ec, n地面[t_].a + 12000, n地面[t_].b + 2000 + 3000, 0, 0, 0, 79, 4);
                                    n敵キャラ.Add(ec);
                        ...
                        if (n地面[t_].type == 180)
                        {
                            ...
                            if (n地面[t_].r >= n地面[t_].gtype)
                            {
                                n地面[t_].r = 0;
                                var ec = new C敵キャラ();
                                v敵キャラアイテム作成(ec,n地面[t_].a, 30000, DX.GetRand(600) - 300, -1600 - DX.GetRand(900), 0, 84, 0);
                                n敵キャラ.Add(ec);
                            }
                        }
